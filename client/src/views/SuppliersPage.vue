      ...
      <b-col class="search-bar">
        <b-input-group>
          ...
          <b-input-group-prepend>
            <b-input-group-text>
              <img :src="searchicon" class="bi-search" />
          ...
          <b-input-group-append>
            <b-button variant="primary" @click="filterSuppliers"
              >Search</b-button
            >
          </b-input-group-append>
        </b-input-group>
        ...
        this.filteredSuppliers = this.suppliers.filter(
          (supplier) =>
            ...
            (supplier.location_of_origin &&
              supplier.location_of_origin.toLowerCase().includes(query))
        )
      }
    },
