<template>
  <b-col :cols="10" class="supplier-container">
    <b-col class="supplier-info">
      ...
      <b-col class="supplier-title"
        >{{ supplier.name }}
        <span class="location-style"
          >Location: {{ supplier.location_of_origin }}</span
        ><br />
        <span class="supplier-description">{{ supplier.description }}</span
        ><br />
        <button @click="goToSupplierDetail" class="detail-button">
          View Supplier Details</button
        ><br />
        <button @click.stop="blockSupplier" class="block-button">
          Block Supplier
        </button>
      </b-col>
    </b-col>
